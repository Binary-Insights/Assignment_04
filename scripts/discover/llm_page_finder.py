...
Usage:
  python scripts/discover/llm_page_finder.py --website "https://worldlabs.ai/" --page-type "product"
  python scripts/discover/llm_page_finder.py --website "https://www.abridge.com/" --page-type "careers"
